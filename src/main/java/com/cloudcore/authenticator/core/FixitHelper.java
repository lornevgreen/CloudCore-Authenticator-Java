    ...
    public FixitHelper(int raidaNumber, String[] ans) {
        ...
        switch (raidaNumber) {
            case 0:
                ...
                break;
            case 1:
                this.trustedServers = new int[]{20, 21, 22, 0, 2, 5, 6, 7};
                break;
            case 2:
                this.trustedServers = new int[]{21, 22, 23, 1, 3, 6, 7, 8};
                break;
            case 3:
                this.trustedServers = new int[]{22, 23, 24, 2, 4, 7, 8, 9};
                break;
            case 4:
                this.trustedServers = new int[]{23, 24, 0, 3, 5, 8, 9, 10};
                break;
            case 5:
                this.trustedServers = new int[]{24, 0, 1, 4, 6, 9, 10, 11};
                break;
            case 6:
                this.trustedServers = new int[]{0, 1, 2, 5, 7, 10, 11, 12};
                break;
            case 7:
                this.trustedServers = new int[]{1, 2, 3, 6, 8, 11, 12, 13};
                break;
            case 8:
                this.trustedServers = new int[]{2, 3, 4, 7, 9, 12, 13, 14};
                break;
            case 9:
                this.trustedServers = new int[]{3, 4, 5, 8, 10, 13, 14, 15};
                break;
            case 10:
                this.trustedServers = new int[]{4, 5, 6, 9, 11, 14, 15, 16};
                break;
            case 11:
                this.trustedServers = new int[]{5, 6, 7, 10, 12, 15, 16, 17};
                break;
            case 12:
                this.trustedServers = new int[]{6, 7, 8, 11, 13, 16, 17, 18};
                break;
            case 13:
                this.trustedServers = new int[]{7, 8, 9, 12, 14, 17, 18, 19};
                break;
            case 14:
                this.trustedServers = new int[]{8, 9, 10, 13, 15, 18, 19, 20};
                break;
            case 15:
                this.trustedServers = new int[]{9, 10, 11, 14, 16, 19, 20, 21};
                break;
            case 16:
                this.trustedServers = new int[]{10, 11, 12, 15, 17, 20, 21, 22};
                break;
            case 17:
                this.trustedServers = new int[]{11, 12, 13, 16, 18, 21, 22, 23};
                break;
            case 18:
                this.trustedServers = new int[]{12, 13, 14, 17, 19, 22, 23, 24};
                break;
            case 19:
                this.trustedServers = new int[]{13, 14, 15, 18, 20, 23, 24, 0};
                break;
            case 20:
                this.trustedServers = new int[]{14, 15, 16, 19, 21, 24, 0, 1};
                break;
            case 21:
                this.trustedServers = new int[]{15, 16, 17, 20, 22, 0, 1, 2};
                break;
            case 22:
                this.trustedServers = new int[]{16, 17, 18, 21, 23, 1, 2, 3};
                break;
            case 23:
                this.trustedServers = new int[]{17, 18, 19, 22, 24, 2, 3, 4};
                break;
            case 24:
